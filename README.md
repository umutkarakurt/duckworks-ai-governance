...
<p align="center">
  <a href="90-visuals/duckworks-ai-use-cases.png">
    <img src="90-visuals/duckworks-ai-use-cases.png" alt="Duckworks AI Use Cases" width="100%">
  </a>
</p>
...
<p align="center">
  <a href="90-visuals/project-wing-governance-lifecycle.png">
    <img src="90-visuals/project-wing-governance-lifecycle.png" alt="Project W.I.N.G. Governance Lifecycle" width="100%">
  </a>
</p>
...
<p align="center">
  <a href="90-visuals/duckworks-ai-portfolio-risk-map.png">
    <img src="90-visuals/duckworks-ai-portfolio-risk-map.png" alt="Duckworks AI Portfolio Risk Map" width="100%">
  </a>
</p>
...
The v1.5 package connects the prior objectives snapshot to a distinct AIMS risk-and-opportunity register, an AIMS-wide management-review record, six assigned actions, and executable follow-up.

The deterministic gate evaluates every action against its due date, dependency and expected result. In the defined synthetic follow-up scenario it detects one overdue escalation and one blocked dependency, meets all six expected results, closes zero actions and requires human disposition.

➡️ **[View the AIMS management-review cycle](12-monitoring-reporting-and-roadmap/01-aims-management-review-cycle/)**

> **Evidence boundary:** This is one bounded synthetic review and follow-up cycle. It does not prove recurring management review, real leadership attendance or approval, completed remediation, production effectiveness, risk acceptance, ISO/IEC 42001 conformity, or certification.

#### AIMS control applicability

The v1.6 package evaluates all 45 canonical controls and records scope, applicability, rationale, owner, risk links, evidence state, required action and review triggers. Forty-four controls are Applicable within their defined scope; `AI-TPR-01` is Conditionally applicable when an external AI provider or material subprocessor is used.

The executable gate validates seven expected outcomes, detects two unsupported Implemented source labels, auto-approves zero decisions and preserves human authority.

➡️ **[View the AIMS control-applicability package](07-control-framework/01-aims-control-applicability/)**

> **Evidence boundary:** Applicability does not prove implementation, operation, effectiveness, normative completeness, legal compliance or ISO/IEC 42001 conformity. All decisions remain fictional or synthetic.

#### AIMS internal-audit programme and first-wave assurance

The v1.7 package converts the complete 45-control applicability population into a risk-based audit universe and four-engagement 2026–2027 programme: two P1 Immediate, 23 P2 High and 20 P3 Medium controls.

First-wave engagement `AUD-AIMS-2026-001` tests the two unsupported `Implemented` labels, `DD-01` and `FF-01`. Fourteen test steps and 12 open evidence requests support two High findings, `IAF-2026-002` and `IAF-2026-003`. The executable gate passes 13 assertions and closes zero findings.

➡️ **[View the AIMS internal-audit programme](11-assurance-testing-and-evaluation/05-aims-internal-audit-programme/)**
...
DuckDesign extends Phase II into **engineering IP, generated-code, software-supply-chain, build/provenance and tool-privilege security**.

The new foundation includes:

- **[DuckDesign Technical Security Reference & Applicability Addendum v1.0](02-regulatory-and-framework-research/Duckworks_DuckDesign_Technical_Security_Reference_Applicability_Addendum_v1.0.md)** — separates product/machinery, AI Act, CRA, trade-secret, privacy and cybersecurity applicability from voluntary technical guidance.
- **[DuckDesign Technical Security Architecture v1.0](10-system-model-and-technical-documentation/02-architecture-and-data-flows/AI-001-duckdesign/Duckworks_DuckDesign_Technical_Security_Architecture_v1.0.md)** — defines engineering-data, provider, generated-artifact, dependency, sandbox, CAD/simulation tool, engineering-validation, safety-gate, approval, provenance, version and telemetry boundaries.
- **[DuckDesign Technical Threat Model v1.0](10-system-model-and-technical-documentation/03-threat-models/AI-001-duckdesign/Duckworks_DuckDesign_Threat_Model_v1.0.md)** — identifies `DDT-001`–`DDT-048` and first-wave design-only cases `DDSEC-T001`–`DDSEC-T012`.

Three security principles anchor the design:
...
> **Engineer approval is valid only for the exact artifact hash/version that was reviewed; required independent safety validation cannot be bypassed by model or engineer workflow.**
...
[Download the AIMS Master Crosswalk v1.6](11-assurance-testing-and-evaluation/03-iso42001/Duckworks_AIMS_Master_Crosswalk_v1.6.xlsx) to trace AI entry → risk → control → evidence → audit priority/finding → decision/trigger → AIMS theme.
...
- **SLSA 1.2 — software supply-chain provenance and build integrity**; and
- **OpenSSF secure software development / source-management guidance**.
...
19. **[ISO/IEC 42001 AIMS Evidence Baseline v1.7](11-assurance-testing-and-evaluation/03-iso42001/duckworks-iso42001-evidence-baseline-v1.7.md)**  
...
20. **[AIMS Master Crosswalk v1.6](11-assurance-testing-and-evaluation/03-iso42001/Duckworks_AIMS_Master_Crosswalk_v1.6.xlsx)**  
...
21. **[AIMS Internal-Audit Programme](11-assurance-testing-and-evaluation/05-aims-internal-audit-programme/)**  
    Review the complete audit universe, annual programme, first-wave DD-01/FF-01 testing, open evidence requests, two High findings, independence limitation and executable coverage gate.

22. **[AIMS Objectives and Support](06-governance-operating-model/01-aims-objectives-and-support/)**  
...
23. **[AIMS Risk, Opportunity and Management Review](12-monitoring-reporting-and-roadmap/01-aims-management-review-cycle/)**  
    Review AIMS-level risks and opportunity, the second objective snapshot, integrated review inputs, retained gate decisions, assigned actions, deterministic escalation and the explicit human-decision boundary.
...
- PondGPT Phase II technical security architecture and threat model;
- WingInspect Phase II technical security architecture, threat model and adversarial-ML validation chain;
...
- AIMS risk-and-opportunity register, AIMS-wide management-review record, action tracker and executable escalation gate;
- AIMS internal-audit procedure, universe, annual programme, first-wave plan, requests, tests, findings and executable gate;
- AIMS Master Crosswalk v1.6;
