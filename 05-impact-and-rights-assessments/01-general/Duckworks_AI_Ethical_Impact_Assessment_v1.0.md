...
### 10.4.1 Related operating evidence — WI-01 Qualified Human Final Inspection

A worked synthetic implementation package for the WingInspect human final-release control is maintained at:

[`../../80-operating-evidence/AI-004-winginspect/`](../../80-operating-evidence/AI-004-winginspect/)

The package operationalizes the existing canonical control **`WI-01 — Qualified Human Final Inspection`** through a **Mandatory Human Release Gate** and links the ethical requirement for meaningful inspector authority to an auditable control chain:

**AI-004-R01 material safety risk → WI-01 Qualified Human Final Inspection → qualified inspector decision → documented override where applicable → final release/block disposition → control test**

The current package includes:

- a Control Implementation Card defining the control, performer, process owner, trigger, required evidence and measurement approach;
- a synthetic inspection log containing 15 AI-assisted inspection events;
- four documented cases in which the qualified human inspector disagrees with the AI output, demonstrating override authority in both directions; and
- a control test showing 100% human-gate compliance across the synthetic authorized-release population.

**Evidence boundary:** These artifacts demonstrate control design, synthetic workflow execution, meaningful human decision authority, audit traceability and test logic. They do **not** establish actual WingInspect model performance, real manufacturing outcomes, longitudinal operating effectiveness, or validated product-safety risk reduction.

Accordingly, this ethical assessment continues to require validated defect performance, sustained human authority, monitoring and separate safety evidence before any broader or safety-critical deployment.
...
### 19.1 AI-004 evidence maturity note

For **AI-004 — WingInspect Vision**, the operating-evidence package provides a worked synthetic example relevant to **ETH-EV-04** (human oversight procedure, training and override evidence) and **ETH-EV-08** (technical validation / safety / robustness test evidence as applicable).

The package supports the **design and synthetic workflow** portions of those evidence expectations, particularly final human authority, override traceability and control-test structure. It does not close the requirement for real operating evidence, validated defect-performance evidence, inspector training/competency evidence, or production safety validation.
...
| AI-004 WingInspect Operating Evidence Package                                  | Synthetic evidence of `WI-01` control design, qualified-human final inspection authority, override traceability and control-test logic; not production operating-effectiveness evidence. | Project evidence |
