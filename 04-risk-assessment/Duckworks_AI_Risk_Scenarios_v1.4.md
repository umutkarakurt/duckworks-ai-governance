...
**Evidence reconciliation snapshot:** v1.3 register plus commit-bound PondGPT PG-03 technical-security validation  
**Supersedes:** Duckworks_AI_Risk_Scenarios_v1.3.md
...
| AI-005 | DuckTalent AI | Beatrice Van Duck - Chief People Officer | Not Implemented / Low | DT-02 synthetic operation tested; one bounded finding-to-closure cycle demonstrated; critical blockers remain | Medium for bounded synthetic testing and improvement / Low for production readiness | Do not deploy in current state | Close privacy, rights, oversight, accessibility, security, vendor and production-validation blockers. |
| AI-006 | PondGPT | Oliver Duckett - Head of IT & Cloud | Partially Effective / Medium | PG-02 synthetic operation tested; one bounded supplier intake-to-change/exit lifecycle demonstrated; PG-03 synthetic technical implementation, hardened operation testing and commit-bound replay demonstrated; production effectiveness and supplier evidence unverified | Medium for bounded synthetic workflow/technical validation / Low for production | Restricted pilot only; broader rollout blocked | Execute and verify supplier conditions; add production permission/connector, provider/tool, DLP/SIEM, adversarial-regression, monitoring, outcome and exit-test evidence. |
...
| Mapped control IDs | AI-GOV-01; AI-GOV-02; AI-TPR-01; DT-01; DT-02; DT-07 |
...
| Available evidence IDs | EV-AI005-001; EV-AI005-002; EV-AI005-003; EV-AI005-004; EV-AI005-005; EV-AI005-006; EV-AI005-009; EV-AI005-010; EV-AI005-011; EV-AI005-012; EV-AI005-013; EV-AI005-014; EV-AI005-015; EV-AI005-016; EV-AI005-017; EV-AI005-018; EV-AI005-019; EV-AI005-020; EV-AI005-021 |
| Evidence maturity | Designed; designed test input; synthetic technical implementation, fairness execution, failure detection, operation, lifecycle decision, material-change monitoring and reassessment demonstrated; bounded synthetic internal-audit finding, root-cause analysis, corrective action, effectiveness review, management-review decision and finding closure demonstrated |
| Score-support status | No reduction claimed |
| Evidence conclusion | Recorded current residual equals inherent risk. The bounded synthetic finding-to-closure cycle demonstrates management-system behavior, but it does not establish production effectiveness, validated risk reduction, or closure of the wider DuckTalent blockers. |
...
| Target residual | Severity 4 x Likelihood 2 = 8 Moderate |
| Available evidence IDs | EV-AI006-001; EV-AI006-002; EV-AI006-003; EV-AI006-004; EV-AI006-005; EV-AI006-006; EV-AI006-009; EV-AI006-010; EV-AI006-011; EV-AI006-012; EV-AI006-013; EV-AI006-014; EV-AI006-015; EV-AI006-016 |
| Evidence maturity | PG-02 synthetic implementation, execution and operation tested; synthetic supplier due diligence, risk treatment, conditional decision, monitoring/exit design, material-change response and executable gate demonstrated |
| Score-support status | Provisional reduction — synthetic evidence only |
| Evidence conclusion | Bounded synthetic technical-control and supplier-governance demonstrations are linked. Supplier terms remain unexecuted, material evidence gaps remain, and sustained production operation, supplier performance and outcomes are not evidenced. |
| Production decision basis | Use inherent risk for production authorization until evidence is accepted by the authorized risk owner. |
| Lifecycle gate | Restricted pilot only; broader rollout and supplier material change `SP-CHG-001` blocked pending conditions |
| Evidence period | Not established in the repository evidence set |
| Reviewer status | Open — authorized risk-owner acceptance not recorded |
| Reassessment trigger | Material model/data/configuration/vendor/use change; control failure; adverse outcome; evidence expiry; or inability to retrieve evidence supporting a current-residual reduction |
...
| Target residual | Severity 4 x Likelihood 2 = 8 Moderate |
| Available evidence IDs | EV-AI006-017; EV-AI006-018; EV-AI006-019; EV-AI006-020; EV-AI006-021; EV-AI006-022 |
| Evidence maturity | PG-03 designed; synthetic technical implementation, seeded failure/remediation, hardened operation testing, detection validation and commit-bound reproducibility demonstrated |
| Score-support status | Provisional reduction — synthetic evidence only |
| Evidence conclusion | Bounded synthetic adversarial-security evidence is now linked to the scenario. The evidence demonstrates the defined lab mechanisms and regression behavior, but not production identity/connectors, real provider/tool boundaries, production telemetry, sustained operation or outcome effectiveness. |
| Production decision basis | Do not use the synthetic PG-03 result to relax the lifecycle gate; use inherent risk conservatively for production authorization until production-relevant evidence is accepted by the authorized risk owner. |
| Lifecycle gate | Restricted pilot only |
| Evidence period | Not established in the repository evidence set |
| Reviewer status | Open — authorized risk-owner acceptance not recorded |
| Reassessment trigger | Material model/data/configuration/vendor/use change; control failure; adverse outcome; evidence expiry; or inability to retrieve evidence supporting a current-residual reduction |
...
**Next scheduled review:** After completion of P1 evidence actions, receipt of production-relevant PondGPT security evidence, or another material repository change, whichever occurs first.
