...
**Evidence reconciliation snapshot:** v1.2 consolidation release plus the bounded PondGPT supplier-governance milestone  
**Supersedes:** Duckworks_AI_Risk_Scenarios_v1.2.md
...
| AI-006 | PondGPT | Oliver Duckett - Head of IT & Cloud | Partially Effective / Medium | PG-02 synthetic operation tested; one bounded supplier intake-to-change/exit lifecycle demonstrated; production effectiveness and supplier evidence unverified | Medium for bounded synthetic workflow / Low for production | Restricted pilot only; broader rollout blocked | Execute and verify supplier conditions; add production permission, connector, DLP/SIEM, regression, monitoring and exit-test evidence. |
