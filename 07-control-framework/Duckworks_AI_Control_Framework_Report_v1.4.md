...
**Evidence reconciliation snapshot:** published v1.5 release plus the bounded AIMS control-applicability milestone  
**Supersedes:** Duckworks_AI_Control_Framework_Report_v1.3.md
...
| AI-GOV-03 | Control Evidence Index | Detective | Eleanor Duckford - AI Governance Lead | Planned | Portfolio-wide evidence governance | EV-AIMS-001; EV-AIMS-002; EV-AIMS-003; EV-AIMS-004; EV-AIMS-005; EV-AIMS-006; EV-AIMS-007; EV-AIMS-008; EV-AIMS-014; EV-AIMS-015; EV-AIMS-016; EV-AIMS-017; EV-AIMS-018; EV-AIMS-019; EV-AIMS-020 | Synthetic objectives, competence, documented-information, management-action and control-applicability operation demonstrated; recurring enterprise operation and production effectiveness unverified | No production risk-reduction credit | Operate the control across the full repository on a defined cadence; retain review, retrieval, access, supersession, exception and human approval evidence. | Open |
