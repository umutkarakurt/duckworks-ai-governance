...
**Status:** Portfolio assurance-readiness and challenge artifacts  

[← Back to main portfolio](../README.md)

This folder demonstrates how Duckworks moves beyond policy creation toward **evaluation, challenge, evidence quality, and independent assurance readiness**.
...
- [`ISO/IEC 42001 AIMS Evidence Baseline v1.3`](03-iso42001/duckworks-iso42001-evidence-baseline-v1.3.md)
- [`AIMS Master Crosswalk v1.2`](03-iso42001/Duckworks_AIMS_Master_Crosswalk_v1.2.xlsx)
...
Internal Audit is treated as an independent third-line function. Second-line review and project self-assessment should not be described as independent audit assurance.
