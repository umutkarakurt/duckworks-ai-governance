...
- [`AI-003-featherforecast/Duckworks_FeatherForecast_Threat_Model_v1.0.md`](AI-003-featherforecast/Duckworks_FeatherForecast_Threat_Model_v1.0.md) — data integrity/poisoning, drift, forecasting resilience, decision authority, access and continuity.
...
They are not evidence that an attack occurred, a production vulnerability exists, a forecast is inaccurate or a control is effective.
