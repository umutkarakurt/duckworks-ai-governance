...
| Field | Value |
|---|---|
| Document ID | DW-WING-TEST-01 |
| Version | 1.0 |
| Test Date | 2026-09-01 |
| AI System | AI-004 — WingInspect Vision |
| Risk ID | AI-004-R01 |
| Control ID | CTRL-004-01 |
| Control | Mandatory Human Release Gate |
...
Determine whether the synthetic implementation of the Mandatory Human Release Gate demonstrates that:
