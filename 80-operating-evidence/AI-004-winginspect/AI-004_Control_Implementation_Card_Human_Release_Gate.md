...
| Field | Value |
|---|---|
| Document ID | DW-WING-WI01-IMPL-01 |
| Version | 1.0 |
| Date | 2026-09-01 |
| AI System | AI-004 — WingInspect Vision |
| Risk ID | AI-004-R01 |
| Control ID | WI-01 |
| Canonical Control Name | Qualified Human Final Inspection |
| Operational Mechanism | Mandatory Human Release Gate |
...
**WI-01 — Qualified Human Final Inspection**, operationalized as a **Mandatory Human Release Gate**.

WingInspect Vision output must not independently authorize product acceptance.
...
**Process owner / accountable control owner:** Henrietta Duckwell — Director Manufacturing

The qualified manufacturing inspector performs and records the final acceptance/rejection decision. The Director Manufacturing owns the operating process and is accountable for ensuring that the control is applied consistently.
