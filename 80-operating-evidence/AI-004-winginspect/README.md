...
↓  
**CTRL-004-01 — Mandatory Human Release Gate**  
↓  
...
Defines the risk, control, operating owner, trigger, evidence produced, and effectiveness measurement.
...
Tests the complete synthetic population against the Mandatory Human Release Gate requirements.
